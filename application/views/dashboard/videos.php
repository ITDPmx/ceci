				...
				<section class="content">
					...
					<div class="row">
						<section class="col-xs-12 col-md-6 col-lg-6 connectedSortable">
							<div class="box box-success" style="border-color: #1A334E;">
								<div class="box-header">
									<h3 class="box-title">Total de reproducciones de los videos por modalidad</h3>
								</div>
								<!-- /.box-header -->
									...
									<table class="table table-hover">
										<tbody>
											...
											<tr>
												...
												<td>
													<?php echo getModalidad($row->id_video); ?>
													<div class="progress progress-xs">
														<div class="progress-bar progress-bar-success" style="width: <?php echo $row->total*100/$sum; ?>%;background:#1A334E;"></div>
													</div>
												</td>
												<td style="text-align:center;"><span class="badge bg-light-success" style="background:#1A334E;font-size: 16px;"><?php echo $row->total; ?></span></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
						...
						<section class="col-xs-12 col-md-6 col-lg-6 connectedSortable">
							<div class="box box-success" style="border-color: #1A334E;">
								<div class="box-header">
									<h3 class="box-title">Total de reproducciones de videos por usuario</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body table-responsive no-padding">
									<table class="table table-hover">
										...
										<tbody>
											<?php foreach($videosUsuarios as $key => $row){ ?>
												<tr>
													<td><?php echo $row->id_usuario;?></td>
													<td><?php echo $row->email;?></td>
													<td style="text-align:center;"><span class="badge bg-success" style="font-size:18px;background:#1A334E !important;"><?php echo $row->mod1; ?></span></td>
													<td style="text-align:center;"><span class="badge bg-success" style="font-size:18px;background:#1A334E !important;"><?php echo $row->mod2; ?></span></td>
													<td style="text-align:center;"><span class="badge bg-success" style="font-size:18px;background:#1A334E !important;"><?php echo $row->mod3; ?></span></td>
													<td style="text-align:center;"><span class="badge bg-success" style="font-size:18px;background:#1A334E !important;"><?php echo $row->mod4; ?></span></td>
													<td style="text-align:center;"><span class="badge bg-success" style="font-size:18px;background:#1A334E !important;"><?php echo $row->mod5; ?></span></td>
												</tr>
											<?php } ?>
										</tbody>
									</table>
