    ...
    <!-- Sparkline -->
    <script src="<?php echo base_url();?>assets/dashboard/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!-- jvectormap -->
    ...
    <!-- ChartJS 1.0.1 -->
    <script src="<?php echo base_url();?>assets/dashboard/plugins/chartjs/Chart.min.js"></script>
